export const cabeceraContent = [
  ...
  },
  {
    text: [
      ...
      {
        text: ' observando lo establecido en el artículo 109 del mismo Reglamento y, recomienda a la Comisión Interventora del Instituto Hondureño de Seguridad Social, proceder a la aprobación  de sesenta y cuatro (64) expedientes relacionados en esta Resolución.',
        style: 'normal',
      },
    ],
  },
  ...
  },
  {
    text: [
      ...
      {
        text: 'La Comisión Interventora del Instituto Hondureño de Seguridad Social en uso de las Facultades que la ley otorga y con fundamento Legal en el Decreto Ejecutivo número PCM 33-2024 y en los artículos: 50, 74, 75, 76, 77, 102 y 107 de la Ley del Seguro Social; 76, 81, 82, 83, 85, 106, 107, 109, 153 y  174  del Reglamento General de la Ley del Seguro Social; 142 de la Constitución de la República; 22, 23, 24, 25  y 72 de la Ley de Procedimiento Administrativo; 99 de la Ley General de la Administración Pública y; dictámenes que corren agregados a cada uno de los expedientes presentados.',
        style: 'normal',
      },
    ],
  },
  ...
  {
    text: 'BENEFICIO DE PENSIÓN POR INCAPACIDAD  PERMANENTE PARCIAL',
    style: 'normalBold',
  },
  {
    text: ['\n'],
