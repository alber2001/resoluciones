...
@Component({
  selector: 'app-pension-permanente-parcial',
  templateUrl: './pension-permanente-parcial.component.html',
  styleUrls: ['./pension-permanente-parcial.component.css']
})
export class PensionPermanenteParcialComponent implements OnInit {
      ...
      documentContent(data: resolucion[]): any[] {
        ...
        data.forEach((item, index) => {
          ...
          const secciones = [
            { text: 'TEGUCIGALPA, M.D.C.', style: 'titulo', lineHeight: 1.2 },
            {
            ...
            },
            {
              text: [
                ...
                {
                  text: 'Que en fecha cuatro (4) de marzo de dos mil veinticinco (2025), según Acta No. CB-05-2025, el Comité de Beneficios del Régimen de Invalidez, Vejez y Muerte, después de haber revisado aleatoriamente los expedientes de mérito, los dictámenes de calificación de riesgo emitidos por la Comisión Técnica de Riesgos Profesionales y los dictámenes médicos emitidos por la Comisión Técnica de Invalidez, se pudo comprobar que los (as) solicitantes reúnen los requisitos exigidos en los artículos 76 y 81 del Reglamento General de la Ley del Seguro Social. Asimismo, pudo comprobar los cálculos emitidos conforme a lo dispuesto en el artículo 81 del Reglamento General de la Ley del Seguro Social y la fecha de efectividad para el goce del beneficio de ',
                  style: 'tituloN',
                  alignment: 'justify',
                  lineHeight: 1.2,
                },
                ...
                {
                  text: 'PENSIÓN POR INCAPACIDAD PERMANENTE PARCIAL ',
                  style: 'titulo',
                  alignment: 'justify',
                  lineHeight: 1.2,
                },
                ...
                {
                  text: 'Dirección ejecutiva, en uso de las facultades que la ley le otorga y con fundamento legal en Los artículos 50, 74, 75, 76, 77, 102 y 107 de la Ley del Seguro Social; 76, 81, 82, 83, 85, 106, 107, 109, 153 y 174 del Reglamento General de la Ley del Seguro Social; 142 de la Constitución de la Republica; 22, 23, 24, 25 y 72 de la Ley de Procedimiento Administrativo y; dictámenes que corren agregados a cada uno de los expedientes presentados. ',
                  style: 'tituloN',
                  alignment: 'justify',
                  lineHeight: 1.2,
                },
                ...
                {
                  text: 'BENEFICIO DE PENSIÓN POR INCAPACIDAD PERMANENTE TOTAL',
                  style: 'titulo',
                  alignment: 'justify',
                  lineHeight: 1.2,
                },
    ...
    
            {
              text: [
                ...
                {
                  text: 'Se hace del conocimiento a los(as) solicitantes que las pensiones de invalidez podrán ser revisadas en cualquier momento. La pensión cesar en caso de que el pensionado recupere la capacidad en la actividad laboral que desempeñaba al momento de pensionarse recuperado más del cincuenta (50%) de su capacidad de ganancia.',
                  style: 'tituloN',
                  alignment: 'justify',
                  lineHeight: 1.2,
                },
