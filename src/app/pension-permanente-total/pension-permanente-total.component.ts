...
@Component({
  selector: 'app-pension-permanente-total',
  templateUrl: './pension-permanente-total.component.html',
  styleUrls: ['./pension-permanente-total.component.css']
})
export class PensionPermanenteTotalComponent implements OnInit {
        ...
        const secciones = [
          ...
          },
          {
            text: [
              ...
              {
                text: 'PENSIÓN POR INCAPACIDAD PERMANENTE TOTAL ',
                style: 'titulo',
                alignment: 'justify',
                lineHeight: 1.3,
              },
              ...
              {
                text: 'Dirección ejecutiva, en uso de las facultades que la ley le otorga y con fundamento legal en Los artículos 74, 75, 76, 77, 102 y 107 de la Ley del Seguro Social; 76, 78, 79, 82, 83, 85, 106, 107, 109, 153 y 174 del Reglamento General de la Ley del Seguro Social; 142 de la Constitución de la Republica; 22, 23, 24, 25 y 72 de la Ley de Procedimiento Administrativo y; dictámenes que corren agregados a cada uno de los expedientes presentados. ',
                style: 'tituloN',
                alignment: 'justify',
                lineHeight: 1.3,
              },
