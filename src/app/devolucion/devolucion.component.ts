        ...
        const secciones = [
          ...
          },
          {
            text: [
              ...
              {
                text:
                  'pudo comprobar que los (as) solicitantes reúnen los requisitos exigidos en el artículo 121 del Reglamento General de la Ley del Seguro Social. Asimismo, pudo comprobar los cálculos emitidos que corresponden al 1% del monto de los salarios base de referencia cuando voluntariamente el asegurado(a) decida retirar las cotizaciones personales efectuadas al Régimen de Invalidez, Vejez y Muerte del Instituto Hondureño de Seguridad Social y, recomienda a la Dirección Ejecutiva del Instituto Hondureño del seguro social, proceder a la aprobación de sesenta y cuatro (' +
                  `${this.Cantidad}` +
              ...
              {
                text: 'Dirección ejecutiva, en uso de las facultades que la ley le otorga y con fundamento legal en Los artículos 74, 75, 76, 77 y 102 de la Ley del Seguro Social; 121, 153, 154 y 174 del Reglamento General de la Ley del Seguro Social; 142 de la Constitución de la Republica; 22, 23, 24, 25 y 72 de la Ley de Procedimiento Administrativo y; dictámenes que corren agregados a cada uno de los expedientes presentados. ',
                style: 'tituloN',
                alignment: 'justify',
                lineHeight: 1.3,
              },
