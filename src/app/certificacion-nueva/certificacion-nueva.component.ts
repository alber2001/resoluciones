    ...
    data.forEach((item, index) => {
      ...
      const secciones = [
        ...
        },
        {
          text: [
            {
              text: `"RESOLUCIÓN No.${item.numero_resolucion}-RIVM-LA CEIBA.- COMISIÓN INTERVENTORA DEL INSTITUTO HONDUREÑO DE SEGURIDAD SOCIAL, `,
              style: 'titulo',
              alignment: 'justify',
              lineHeight: 1.3,
            },
            ...
            {
              text: 'La Comisión Interventora del Instituto Hondureño de Seguridad Social, en uso de las facultades que la ley le otorga y con fundamento legal en el artículo 142 de la Constitución de la República; en los artículos 52, 74, 75, 76, 77, 88 y 102 de la Ley del Seguro Social; en el artículo 99 de la Ley General de la Administración Pública; en los artículos 22, 23, 24, 25 y 72 de la Ley de Procedimiento Administrativo; en los artículos 6, 111, 116, 117, 118, 119, 153, 168, 169, 170 y 174 del Reglamento General de la Ley del Seguro Social; en el Decreto Ejecutivo número PCM 33-2024; y en los dictámenes agregados a cada uno de los expedientes presentados. ',
              style: 'tituloN',
              alignment: 'justify',
              lineHeight: 1.3,
            },
